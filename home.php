<?php
/**
 * Ce code génère la structure HTML d'une page web avec un contenu principal.
 * Il inclut l'en-tête, le corps de la page et un pied de page.
 * Le contenu principal présente des informations sur la création, la gestion des informations, des alertes et des utilisateurs.
 */
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 mx-auto col-md-6 order-md-2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/media/user.png" alt="Logo utilisateur" class="img-fluid mb-3 mb-md-
                </div>
